...
import { FaEnvelope, FaChartLine, FaBullhorn, FaRegLightbulb, FaSyncAlt, FaPlus, FaMinus } from "react-icons/fa";
...
export default function EmailMarketing() {
  ...
  return (
    <div className="bg-white text-slate-800">
      ...
      >
        <FaEnvelope className="mx-auto text-primary-medium text-5xl mb-4 animate-bounce" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
          {strategyPoints.map((item, idx) => (
            <motion.div
              ...
              variants={sectionVariant}
            >
              <FaChartLine className="text-primary-medium text-4xl mb-4" />
              <p>{item}</p>
            </motion.div>
          ))}
        </div>
