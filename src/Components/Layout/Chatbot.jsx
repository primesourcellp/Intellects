...
import { MessageCircle, Send, X, Bot, Copy, Trash2, ExternalLink, RotateCcw } from "lucide-react";
    ...
    services: {
      ...
      hiring: {
        ...
        response: {
          ...
          links: [
            { text: "Global Recruitment", path: "/services/global-recruitments" },
            { text: "Contract Staffing", path: "/services/contract-staffing" },
            { text: "Staffing Services", path: "/services/staffing-services" },
          ],
